...
import { collection, query, where, getDocs, Timestamp, updateDoc, increment } from 'firebase/firestore';
...
export default class TransactionScreen extends Component {
	...
	handleTransaction = async () => {
		...
		bookRef.forEach((doc) => {
			...
			if (book.is_book_available) {
				...
				ToastAndroid.show('Book has been returned to the library',ToastAndroid.SHORT);
			}
		});
	};
	...
	initiateBookIssue = async(bookId,studentId,bookName,studentName) => {
		...
		//update the local state in database
